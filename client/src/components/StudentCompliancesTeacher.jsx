...
import { ClipboardCheck, AlertTriangle, PlusCircle } from "lucide-react";
  ...
  const teachers = [
    {
      ...
      name: "Dr. Sharma",
      assignedCompliances: [
        { id: 1, student: "John Doe", compliance: "Project Report", status: "Approved" },
        { id: 2, student: "Alice Johnson", compliance: "Lab Records", status: "Pending" },
      ],
    },
    {
      id: 2,
      name: "Ms. Verma",
      assignedCompliances: [
        { id: 3, student: "Jane Smith", compliance: "Assignment Submission", status: "Rejected" },
        { id: 4, student: "John Doe", compliance: "Attendance Record", status: "Approved" },
      ],
    },
  ];
                ...
                <React.Fragment key={teacher.id}>
                  {teacher.assignedCompliances.map((compliance, index) => (
                    <tr key={compliance.id} className="hover:bg-gray-50">
                      {index === 0 && (
                        <td rowSpan={teacher.assignedCompliances.length} className="py-2 px-4 border-b text-center font-medium">
                          {teacher.name}
                        </td>
                      )}
                      <td className="py-2 px-4 border-b">{compliance.student}</td>
                      <td className="py-2 px-4 border-b">{compliance.compliance}</td>
